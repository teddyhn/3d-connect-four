    ...
    return (
        <div className="absolute w-full h-full flex items-center">
            <div className="z-10 mx-auto bg-white text-gray-800 shadow-lg py-6 px-12 rounded flex flex-col items-center">
                ...
                {color === "red"
                    ? <div className="font-semibold text-lg mb-4"><span className="text-red-500">Red</span> won!</div>
                    : <div className="font-semibold text-lg mb-4"><span className="text-blue-500">Blue</span> won!</div>
                }
